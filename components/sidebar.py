...
layout = dbc.Col([
                ...
                html.P("By Renato Agnello", className="text-info"),
                html.Br(),
                ...
                dbc.Modal([
                    ...
                    dbc.ModalBody([
                        dbc.Row([
                            dbc.Col([
                                dbc.Label('Descrição: '),
                                dbc.Input(placeholder='Ex: Combustível, alimentação...', id='txt-despesa'),
                            ], width=6),
                            dbc.Col([
                                dbc.Label("Valor: "),
                                ...
                                dbc.AccordionItem(children=[
                                    dbc.Row([
                                        ...
                                        dbc.Col([
                                            html.Legend('Excluir categorias', style={'color': 'red'}),
                                            dbc.Checklist(
                                                id='checkedlist-selected-style-despesa',
                                                options=[],
                                                value=[],
                                                label_checked_style={'color': 'red'},
                                                input_checked_style={'backgroundColor': 'blue', 'borderColor': 'orange'},
...
# Callback para armazenamento do dataframe de receitas
@app.callback(
...
# Callback para armazenamento do dataframe de despesas
@app.callback(
